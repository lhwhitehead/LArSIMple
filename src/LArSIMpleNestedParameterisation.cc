...
LArSIMpleNestedParameterisation::LArSIMpleNestedParameterisation(std::vector<G4Material*> material,
  const double sizeX, const double sizeY, const double sizeZ, const int nRepZ) :
  G4VNestedParameterisation(), fSizeX(sizeX), fSizeY(sizeY), fSizeZ(sizeZ), fNRepZ(nRepZ),
  fMaterials(material)
{
